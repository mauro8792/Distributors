       ...
       <div class="col-md-12 col-md-offset-8">
            ...
            <table class="table table-responsive">
                <thead class="thead-light">
                    <th scope="col"><a href="/empleados/{{$orden}}" class="text-success" style="text-decoration:none" data-toggle="tooltip" title="Orden {{$orden}}">Nombre&nbsp;<i class="fa fa-arrow-{{($orden=='asc')?'down':'up'}}"></i></a></th>
